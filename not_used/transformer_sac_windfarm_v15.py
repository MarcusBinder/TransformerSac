"""
Transformer-based SAC for Wind Farm Control - V15
...
class TransformerActor(nn.Module):
    ...
    def __init__(
        ...
        if self.uses_additive_embedding:
            ...
            # Relative encoding: just obs_embed → embed_dim (already correct size)
...
def main():
    ...
    rb = TransformerReplayBuffer(args.buffer_size, device, rotor_diameter,use_wind_relative=args.use_wind_relative_pos)
